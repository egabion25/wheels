...
'options' => array (
	...
	'id' => 'fluida_headerresponsive',
		...
		'desc' => __("Select how your header image looks and behaves.<br> A <strong>Contained</strong> header image will scale depending on the viewed resolution, while a <strong>Cropped</strong> header image will always have the configured height.","fluida"),
	'section' => 'fluida_siteheader' ),
	array(
	...
	'id' => 'fluida_lpblockscontent#',
		...
		'values' => array( 0, 1, 2 ),
		'labels' => array( __("Disabled","fluida"), __("Excerpt","fluida"), __("Full Content","fluida") ),
	...
	'id' => 'fluida_lptextfour',
		...
		'values' => cryout_pages_for_customizer(1, __('Disabled', 'fluida') ),
		'labels' => cryout_pages_for_customizer(2, __('Disabled', 'fluida') ),
		'desc' => __("This text area is displayed below the posts list.","fluida"),
	'section' => 'fluida_lptexts' ),
	array(
	...
	'id' => 'fluida_lpblocksbg',
		'type' => 'color',
		'label' => __('Blocks Background','fluida'),
		'desc' => '',
	'section' => 'fluida_colors_lp' ),
	array(
	'id' => 'fluida_lpboxesbg',
		'type' => 'color',
		'label' => __('Boxes Background','fluida'),
		'desc' => '',
	'section' => 'fluida_colors_lp' ),
	array(
	'id' => 'fluida_lptextsbg',
		'type' => 'color',
		'label' => __('Text Areas Background','fluida'),
		'desc' => '',
	'section' => 'fluida_colors_lp' ),
	array(
	'id' => 'fluida_accent1',
...
array(
	...
	'id' => 'fluida_fheight',
		'type' => 'number',
		'label' => __( 'Max Featured Image Height (in pixels)', 'fluida' ),
	...
	'id' => 'fluida_fheight_notice',
		...
		'label' => '',
		'input_attrs' => array( 'class' => 'warning' ),
		'desc' => __("Changing this value may require to regenerate your thumbnails.","fluida"),
		//'active_callback' => 'fluida_conditionals',
	'section' => 'fluida_featured' ),
	array(
	'id' => 'fluida_fresponsive',
		...
		'desc' => __("Select how your featured image looks and behaves.<br>A <strong>Contained</strong> featured image will scale depending on the viewed resolution, while a <strong>Cropped</strong> featured image will always have the configured height.","fluida"),
	'section' => 'fluida_featured' ),
	array(
	'id' => 'fluida_falign',
		'type' => 'select',
