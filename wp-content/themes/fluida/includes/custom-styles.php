...
$sidebarP = intval($fluida_primarysidebar);
$sidebarS = intval($fluida_secondarysidebar);
?>
...
#access > div > ul > li.menu-main-search:hover,
...
#mobile-menu .mobile-arrow 					{ color: <?php esc_html( $fluida_sitetext ) ?>; }
